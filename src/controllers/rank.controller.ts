...
import { R6Service, IGetRanks } from 'r6-api-caching';
...
export class RankController {
  ...
  async getRankById(@Param() params: PlatformId): Promise<IGetRanks | null> {
  ...
  async getRankByUsername(@Param() params: PlatformUsername): Promise<IGetRanks | null> {
